...
namespace SnakeGame
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.BackgroundColor = ConsoleColor.DarkBlue; // Cambio de color de fondo
        ...
        {
            Console.ForegroundColor = ConsoleColor.Yellow; // Cambio de color de los bordes
        ...
        static void DrawFood()
        {
            ...
            Console.ForegroundColor = ConsoleColor.Green; // Cambio de color de la comida
            Console.Write("$"); // Cambio de carácter de la comida
        }
        ...
        static void DrawSnake()
        {
            ...
            Console.ForegroundColor = ConsoleColor.Magenta; // Cambio de color de la serpiente
            Console.Write("O"); // Cambio de carácter de la serpiente
        }
